...
A 3D file inspector for Windows. Drop in an FBX, OBJ, GLB/glTF, USD, STL, PLY, DAE, BLEND or Houdini file and see every mesh, material, texture and transform inside it — no import, no viewport.
